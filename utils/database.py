...
setup_query = [
    ...
    'CREATE TABLE IF NOT EXISTS osu_users (user_id INTEGER PRIMARY KEY, osu_user TEXT)',
    'CREATE TABLE IF NOT EXISTS osu_expand (guild INTEGER PRIMARY KEY, bool BOOLEAN)',
