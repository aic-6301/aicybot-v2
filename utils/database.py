...
setup_query = [
    ...
    'CREATE TABLE IF NOT EXISTS vc_panel (guild INTEGER PRIMARY KEY, bool BOOLEAN)',
    'CREATE TABLE IF NOT EXISTS voice_channels (id INTEGER PRIMARY KEY, guild INTEGER, channel INTEGER, owner INTEGER)',
]
